    ...
    <div class="form-container">
        ...
        <form method="POST" action="">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="email" aria-describedby="basic-addon2" placeholder="почта@mail.ru" />
            </div>
            <div class="input-group">
                <span class="input-group-text" id="basic-addon3">Дата рождения</span>
                <input type="date" class="form-control" aria-describedby="basic-addon3"  name="birth"/>
            </div>
